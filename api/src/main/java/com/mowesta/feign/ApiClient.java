...
import com.mowesta.feign.auth.*;
import com.mowesta.feign.auth.OAuth.AccessTokenListener;
...
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2017-10-20T17:10:12.901+02:00")
public class ApiClient {
  public interface Api {}

  protected ObjectMapper objectMapper;
  private String basePath = "https://www.mowesta.com/api";
  ...
  public ApiClient() {
    ...
    feignBuilder = Feign.builder()
            .requestInterceptor(request -> {
              Map<String, Collection<String>> headers = request.request().headers();
              if (!headers.containsKey("Content-Type" ) && request.method().equals("DELETE") ) {
